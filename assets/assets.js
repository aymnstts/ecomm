...
export const categories = ["Men", "Women", "Packs", "Samples", "Niche Fragrances"];
...
export const ourSpecsData = [
    { title: "Shipping All Morocco", description: "Enjoy fast delivery on every order no conditions, just reliable doorstep.", icon: SendIcon, accent: '#05DF72' },
    { title: "Cash On delivery", description: "Pay only when you get your order.", icon: ClockFadingIcon, accent: '#FF8904' },
