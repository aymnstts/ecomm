...
const Footer = () => {
    ...
    const TikTokIcon = () => (  <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"> <path d="M14.168 1.66699H11.2513V13.4587C11.2513 14.8753 10.1013 16.042 8.66797 16.042C7.23464 16.042 6.08464 14.8753 6.08464 13.4587C6.08464 12.0753 7.20964 10.9253 8.5763 10.8837V7.93366C5.6013 7.97533 3.16797 10.4503 3.16797 13.4587C3.16797 16.4837 5.64297 18.9587 8.66797 18.9587C11.693 18.9587 14.168 16.4837 14.168 13.4587V7.10033C15.218 7.87533 16.5013 8.33366 17.918 8.36699V5.41699C15.818 5.33366 14.168 3.61699 14.168 1.66699Z" stroke="#90A1B9" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/></svg>
)
    const linkSections = [
        {
            title: "PRODUCTS",
        ...
        },
        {
            title: "CONTACT",
            links: [
                { text: "+212 6 16 11 42 60 ", path: '/', icon: PhoneIcon },
                { text: "aurafragrance1@gmail.com", path: '/', icon: MailIcon },
                { text: "Marrakech, 40000", path: '/', icon: MapPinIcon }
            ]
        }
    ];
    ...
    <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b border-slate-500/30 text-slate-500">
            <div>
                ...
                <p className="max-w-[410px] mt-6 text-sm">Welcome to AuraParfums, your ultimate destination for the latest fragrances. From Designers and Niche you will find your daily scent, we bring you the best — all in one place.</p>
        ...
        <p className="py-4 text-sm text-slate-500">
            Copyright 2025 © AuraParfums All Right Reserved.
        </p>
    </div>
</footer>
    );
